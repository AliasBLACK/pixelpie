package black.alias.pixelpie.ui.input;
...
public class InputSystemProcessing implements InputSystem {
	...
	public void setMousePosition(int x, int y) {
		// Not possible in Processing.
	}

	/**
	 * Handle MouseEvents from Processing. (and also TouchEvents)
	 ...
	 */
	private void handleKeyEvent(processing.event.KeyEvent event, char key, boolean isKeyDown) {
